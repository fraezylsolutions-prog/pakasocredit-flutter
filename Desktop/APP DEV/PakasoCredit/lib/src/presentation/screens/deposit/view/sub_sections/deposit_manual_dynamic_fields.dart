...
class _DepositManualDynamicFieldsState
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final paymentDetails = depositController.paymentDetails.value;
      final fieldOptions = depositController.gatewayFieldOptions.value;
          ...
          if (paymentDetails.isNotEmpty) ...[
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFF0D2150).withValues(alpha: 0.06),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: const Color(0xFF0D2150).withValues(alpha: 0.15),
                ),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Row(
                    children: [
                      const Icon(Icons.info_outline_rounded,
                          color: Color(0xFF0D2150), size: 16),
            ...
            Builder(builder: (context) {
              try {
                final Map<String, dynamic> parsedFields =
                    jsonDecode(fieldOptions);
                if (parsedFields.isEmpty) return const SizedBox.shrink();
                return Column(
                  children: [
