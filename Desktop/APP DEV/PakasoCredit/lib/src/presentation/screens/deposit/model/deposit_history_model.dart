class DepositHistoryModel {
  List<DepositHistoryData>? data;
  Links? links;
  Meta? meta;

  DepositHistoryModel({this.data, this.links, this.meta});

  factory DepositHistoryModel.fromJson(Map<String, dynamic> json) {
    var dataList = <DepositHistoryData>[];
    if (json['data'] != null) {
      json['data'].forEach((v) {
        dataList.add(DepositHistoryData.fromJson(v));
      });
    }
...
class DepositHistoryData {
  ...
  factory DepositHistoryData.fromJson(Map<String, dynamic> json) {
    return DepositHistoryData(
      ...
      isPlus: json['is_plus'] == true || json['is_plus'] == 1 || json['is_plus'] == "1",
