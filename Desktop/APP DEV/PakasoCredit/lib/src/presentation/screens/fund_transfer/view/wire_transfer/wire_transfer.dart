...
class _WireTransferState extends State<WireTransfer> {
  ...
  Future<void> loadData() async {
    ...
    try {
      ...
      debugPrint('Wire transfer load error: $e');
    } finally {
        ...
        children: [
          Container(
            ...
            child: Obx(() {
              ...
              if (wireTransferController.wireTransferSettingsModel.value.data == null) {
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Initiate Transfer is being set up.\nPlease check back soon.',
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 13, color: Colors.grey.shade500, fontFamily: 'Plus Jakarta Sans'),
                      ),
                      const SizedBox(height: 16),
                      ElevatedButton(
                        onPressed: () => loadData(),
                        style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF0D2150)),
              ...
              try {
                final raw = wireTransferController.wireTransferSettingsModel.value.data?.fieldOptions;
                if (raw != null && raw.isNotEmpty) {
                  parsedFields = jsonDecode(raw);
                }
              } catch (e) {
